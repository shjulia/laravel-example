                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="percent_off" type="text" class="form-control{{ $errors->has('percent_off') ? ' is-invalid' : '' }}" name="percent_off" value="{{ old('percent_off') }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="dollar_off" type="text" class="form-control{{ $errors->has('dollar_off') ? ' is-invalid' : '' }}" name="dollar_off" value="{{ old('dollar_off') }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="minimum_bill" type="text" class="form-control{{ $errors->has('minimum_bill') ? ' is-invalid' : '' }}" name="minimum_bill" value="{{ old('minimum_bill') }}">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="use_per_account_limit" type="number" class="form-control{{ $errors->has('use_per_account_limit') ? ' is-invalid' : '' }}" name="use_per_account_limit" value="{{ old('use_per_account_limit') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="use_globally_limit" type="number" class="form-control{{ $errors->has('use_globally_limit') ? ' is-invalid' : '' }}" name="use_globally_limit" value="{{ old('use_globally_limit') }}">
                                        ...
                                        >
                                            @foreach ($positions as $position)
                                                @if($position->children->isEmpty())
                                                    ...
                                                    <option
                                                        value="{{ $position->id }}"
                                                        @if(in_array($position->id, old('position', []))) selected @endif
                                                    >
                                                        {{ $position->title }}
                                                    </option>
                                                @else
                                                    <optgroup label="{{ $position->title }}">
                                                        @foreach ($position->children as $child)
                                                            <option
                                                                value="{{ $child->id }}"
                                                                @if(in_array($child->id, old('position', []))) selected @endif
                                                            >
                                                                {{ $child->title }}
                                                            </option>
                                                        @endforeach
                                    ...
                                    <div class="form-group">
                                        ...
                                        >
                                            @foreach ($states as $state)
                                                <option value="{{ $state->id }}" @if(in_array($state->id, old('state', []))) selected @endif>{{ $state->title }}</option>
                                            @endforeach
                                        </select>
                                        @if ($errors->has('state'))
                                            <span class="invalid-feedback" role="alert">
